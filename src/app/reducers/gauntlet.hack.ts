import {GauntletState} from './gauntlet.reducer';

export const gauntlet: GauntletState = {
  powerStone: {
  ...
  timeStone: {
    description: 'Total control over all aspects of time including time travel, stopping time, slowing down or speed up flow of time and ' +
      'to accelerate or slow down aging.',
